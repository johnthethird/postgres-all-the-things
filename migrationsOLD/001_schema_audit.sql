...
-- From https://raw.githubusercontent.com/m-martinez/pg-audit-json/master/sql/pg-audit-json--1.0.0.sql
--
...
BEGIN
  ...
  audit_row = ROW(
    ...
    current_setting('request.jwt.claim.email', true), -- client user name
